...
of its host galaxy as well as mass loss due to stellar evolution. Despite the fact that this one
simple process is essentially the sole driver of the evolution of GCs, they nonetheless display a
wide range dynamical phenomena. Among these phenomena, mass segregation is a process through which
...
rest of the clusters. When the process of mass segregation continues without halting, the core of
the cluster becomes extremely dense leading to a density profile that rises all the way to the
centre of the cluster and a core that is visually very compact \citep{Heggie2003}. The distinction
between core-collapsed and non-core-collapsed clusters is an area of active study and the halting of
core-collapse has been attributed to both populations of binary stars \citep{Chatterjee2013} and to
large populations of heavy remnants \citep{Kremer2019}.
