...
\ps{Rewrite this so it reads nicely}
...
increase the runtime for the \code{LIMEPY} models. In order to prevent this we group together binary
...
GCfit provides a uniform interface for fitting \evolvemf{} and \code{LIMEPY} models to observations
