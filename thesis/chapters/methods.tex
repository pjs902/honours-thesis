...
line-of-sight position as calculated from the dispersion measure (DM) of the pulsar or the density
of pulsar-mass objects at that radius. This likelihood distribution is then convolved with a
...
model parameters to determine the luminosity of the binary components and then again use the
isochrone to determine the observed mass of the combined luminosities. Figure \ref{fig:2/isochrone}
shows the derived relation between stellar mass and luminosity used for these conversions. After
having determined at what mass a binary system would have been "observed", we then scale the surface
